  ...
  return (
    <>
      ...
      <div className={`bg-hero-pattern h-screen bg-repeat-round flex flex-col items-center justify-center`}>
        <h1 className={` font-extrabold lg:text-[80px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[98px] mt-2 mb-3 shadow-lg text-transparent bg-clip-text bg-gradient-to-r from-violet-500 to-fuchsia-500`}>Not Found</h1>
