...
const Homepage = () => {
  ...
  const schema = {
    ...
    image: "https://leonatk.dev/logo.svg", // Replace with actual profile image URL
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Leonat Krasniqi, a Full Stack Developer with expertise in TypeScript, JavaScript, React Native, and Node.js. Specializing in developing dynamic, efficient, and scalable mobile and web applications. Explore my portfolio to see my work on innovative projects like DevKit(Google extension), Folder VScode(Visual studion extension), Loggerv2(Npm libary)."
        />
        <meta
          name="keywords"
        ...
        />
        <link rel="canonical" href="https://leonatk.dev/" />
        ...
        <meta property="og:url" content="https://leonatk.dev/" />
        <meta property="og:image" content="" />
        <meta
          property="og:description"
          content="Explore the portfolio of Leonat Krasniqi, a Full Stack Developer with a focus on mobile and web application development. Featuring projects like DevKit(Google extension), Folder VScode(Visual studion extension), Loggerv2(Npm libary)."
        />
        ...
        />
        <meta name="twitter:image" content="https://leonatk.dev/logo.svg" />
        {/* Schema Markup */}
